...
const Logo = (
  <div className="w-10 h-10" tabIndex={-1}>
    <Link href="/">
      <IconLogo></IconLogo>
    </Link>
  </div>
...
export const NavBar = () => {
  return (
    <header className="flex justify-between items-center fixed top-0 z-[11] px-12 w-full h-24 filter-none pointer-events-auto select-auto backdrop-blur-md transition-all">
      <nav
